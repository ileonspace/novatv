        ...
        {options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={`relative z-10 px-2.5 py-1.5 sm:px-4 sm:py-2 text-[13px] sm:text-[13px] font-medium rounded-full transition-all duration-150 whitespace-nowrap ${
                isActive
      ...
      {type === 'movie' && (
        <div className='space-y-3 sm:space-y-4'>
          ...
          <div className='flex flex-col sm:flex-row sm:items-center gap-2'>
            <span className='text-[13px] sm:text-[13px] font-medium text-gray-600 dark:text-gray-400 min-w-[48px]'>
              分类
            </span>
